...
EXPECTED_OPTIONS = [
    ...
    SetTrueOption('--package-parser', dest='build_packageparser'),
    ...
    DisableOption('--skip-test-package-parser', dest='test_packageparser'),
