# swift_build_support/products/packageparser.py -----------------*- python -*-
#
...
class PackageSyntaxParser(product.Product):
    @classmethod
    ...
    def should_test(self, host_target):
        return self.args.test_packageparser
